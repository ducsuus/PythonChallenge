...
for i in range(0, len(text)):
    ...
    if True:
        ...
        if text[i-4].islower() and text[i-3].isupper() and text[i-2].isupper() and text[i-1].isupper() and text[i].islower() and text[i+1].isupper() and text[i+2].isupper() and text[i+3].isupper() and text[i+4].islower():
            print(text[i-3] + text[i-2] + text[i-1] + text[i+1] + text[i+2] + text[i+3])
